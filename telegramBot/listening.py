...
# Function to use gTTS to read dialogue aloud
def read_dialogue(text):
    # Create a gTTS object with the text and language code for Korean ('ko')
...
# Function to display a question and read the dialogue
...
# Main loop to randomly choose a question and make it interactive
def main():
    # Randomly select a question
    selected_question = random.choice(questions)
    
    # Display and read the selected question
    display_question(selected_question)
    
    # Take user input (answer selection)
    try:
